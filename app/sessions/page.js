          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
              <button onClick={() => setSelected(null)}
                style={{ background: 'transparent', border: '1px solid #D9C9B3', borderRadius: 10, padding: '8px 16px', color: '#8B7355', fontSize: 13, cursor: 'pointer' }}>
                Back to sessions
              </button>
              <button onClick={() => handleDownloadPDF(selected)}
                style={{ background: '#8B6240', color: '#FFF', border: 'none', borderRadius: 10, padding: '8px 20px', fontSize: 13, fontWeight: 700, cursor: 'pointer' }}>
                Download PDF
              </button>
            </div>
